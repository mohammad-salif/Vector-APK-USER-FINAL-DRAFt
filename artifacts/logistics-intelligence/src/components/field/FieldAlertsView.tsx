    ...
    <div id="field-alerts-screen" className="flex flex-col gap-4 sm:gap-5 pb-8">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-neutral-200/90 pb-3">
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-xs text-neutral-500">
            Driver V. Rawat • Vehicle VHC-2044 • Corridor Delta (RTE-104)
          </p>
        </div>
      ...
      <div className="rounded-xl border border-neutral-200 bg-neutral-50/70 p-3 text-xs text-neutral-700">
        <div className="flex items-start gap-2">
          ...
          <div className="min-w-0 flex-1 text-[11px] leading-relaxed">
            <span className="font-bold text-neutral-900">{t.alertsHeaderTitle}:</span>{' '}
            {t.alertsSubtitle}
          </div>
        </div>
      </div>
            ...
            <div className="mt-1 flex items-center gap-1.5 font-bold">
              {isOnline ? (
                <>
                  ...
                  <span className="text-emerald-900">{t.statusConnected}</span>
                </>
              ) : (
                <>
                  <span className="h-2 w-2 rounded-full bg-amber-500" />
                  <span className="text-amber-900">{t.statusOffline}</span>
                </>
              )}
            </div>
            <p className="mt-0.5 text-[10px] text-neutral-500">
              {isOnline ? t.connectedText : t.offlineTooltip}
            </p>
          </div>
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs -mx-1 px-1">
        ...
        >
          ...
          <span>{t.sevCritical} ({counts.critical})</span>
        </button>
        ...
        >
          <span className="h-2 w-2 rounded-full bg-amber-500" />
          <span>{t.statusWarning} ({counts.warning})</span>
        </button>
        ...
        >
          <span>{t.statusInfo} ({counts.info})</span>
        </button>
        ...
        >
          <span className="h-2 w-2 rounded-full bg-emerald-500" />
          <span>{t.statusResolved} ({counts.resolved})</span>
        </button>
      </div>
      ...
      <div className="flex flex-col gap-3">
        {filteredAlerts.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-300 bg-white p-8 text-center text-neutral-500 shadow-xs">
            ...
            <p className="text-sm font-semibold text-neutral-800">{t.noAlertsFound}</p>
                ...
                <div className="rounded-xl border border-neutral-200/80 bg-white/80 p-2.5 text-xs space-y-1.5">
                  <div className="grid grid-cols-1 gap-1 sm:grid-cols-3 text-[11px]">
                    <div className="flex items-center gap-1.5 text-neutral-700">
                      ...
                      <span className="font-semibold text-neutral-500">{t.affectedCorridorLabel}:</span>
                    ...
                    <div className="flex items-center gap-1.5 text-neutral-700">
                      ...
                      <span className="font-semibold text-neutral-500">{t.affectedVehicleLabel}:</span>
                    ...
                    {alert.affectedDelivery ? (
                      <div className="flex items-center gap-1.5 text-neutral-700">
                        ...
                        <span className="font-semibold text-neutral-500">{t.cargoCategoryLabel}:</span>
                      ...
                      <div className="flex items-center gap-1.5 text-neutral-500">
                        ...
                        <span>{t.cargoCategoryLabel}: N/A</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 pt-1 border-t border-neutral-100 text-[10px] text-neutral-500">
                    <span>
                      <strong className="text-neutral-600">ID:</strong> {alert.id}
                    </span>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1 border-t border-neutral-200/60">
                  ...
                  {alert.deliveryId && (
                    ...
                    >
                      ...
                      <span>{t.viewAffectedDelivery}</span>
                  ...
                  {alert.incidentId && onViewIncident && (
                    ...
                    >
                      ...
                      <span>{t.reportRelatedIncident} ({alert.incidentId})</span>
                    </button>
                  )}
                  ...
                  {!isResolved && (
                    ...
                    >
                      ...
                      <span>{isAcknowledged ? t.acknowledgedBtn : t.acknowledgeBtn}</span>
                    </button>
                  )}
                </div>
              </div>
