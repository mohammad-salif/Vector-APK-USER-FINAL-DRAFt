...
import { VectorMark } from '@/components/brand/VectorBrand';
      ...
      <header className="shrink-0 border-b border-neutral-200/90 bg-white/95 backdrop-blur-md z-40 shadow-xs">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-3 py-2.5 sm:px-4 sm:py-3">
          <div className="flex min-w-0 items-center gap-2 sm:gap-2.5">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-neutral-200/90 bg-white text-neutral-900 shadow-2xs">
              <VectorMark size={22} variant="dark" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="truncate text-sm font-black tracking-tight text-neutral-950">{t.appTitle}</span>
      ...
      >
        <div className="mx-auto flex max-w-3xl items-center justify-between px-1 py-1 sm:px-2 sm:py-1.5 pb-[calc(0.375rem+env(safe-area-inset-bottom,0px))]">
          ...
          >
            ...
            <span className="whitespace-nowrap">{t.navDelivery}</span>
          </button>
          ...
          >
            ...
            <span className="whitespace-nowrap">{t.navRoute}</span>
          </button>
          ...
          >
            ...
            <span className="whitespace-nowrap">{t.navAlerts}</span>
          </button>
          ...
          >
            ...
            <span className="whitespace-nowrap">{t.navReports}</span>
          </button>
        </div>
      </nav>
    </div>
